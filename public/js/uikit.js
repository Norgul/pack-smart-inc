...
(function (global, factory) {
    ...
    var Dimensions = {
        ...
        fit: function fit(dimensions, maxDimensions) {
            ...
            $$1.each(dimensions, function (prop) {
    ...
    function internalAPI(UIkit) {
        ...
        UIkit.prototype._initObserver = function () {
            ...
            this._observer = new Observer(function (mutations) {
                ...
                if (mutations
                        .map(function (mutation) {
                            return camelize(mutation.attributeName);
                        })
                        .some(function (key) {
            ...
            this._observer.observe(this.$options.el, {
                attributes: true,
                attributeFilter: Object.keys(this.$options.props).map(function (key) {
    ...
    function componentAPI(UIkit) {
        ...
        UIkit.component = function (id, options) {
            ...
            UIkit[name] = function (element, data) {
                ...
                return element && element[DATA] && element[DATA][name] || new UIkit.components[name]({
                        el: element,
                        data: data
                    });
            };
        ...
        UIkit.getComponents = function (element) {
            return element && toNode(element)[DATA] || {};
        };
        UIkit.getComponent = function (element, name) {
            return element && UIkit.getComponents(element)[name];
        };
        ...
        methods: {
            ...
            toggleElement: function toggleElement(targets, show, animate) {
                ...
                return all(toggles).then(function () {
                    return this$1.queued !== true && delay(this$1.queued);
                });
            },
            ...
            toggleNow: function toggleNow(targets, show) {
                ...
                return promise.all($$1__default(targets).toArray().map(function (el) {
            ...
            _toggleHeight: function _toggleHeight(el, show) {
                ...
                return Transition.cancel(el).then(function () {
                    ...
                    return show
                        ? Transition.start(el, $$1.extend(this$1.initProps, {
                        overflow: 'hidden',
                        height: endHeight
        ...
        UIkit.component('accordion', {
            ...
            update: function update() {
                ...
                var items = $$1__default(this.targets, this.$el),
                    changed = !this.items || items.length !== this.items.length || items.toArray().some(function (el, i) {
                            return el !== this$1.items.get(i);
                        });
        ...
        UIkit.component('drop', {
            ...
            methods: {
                ...
                show: function show(toggle, delay) {
                    ...
                    var show = function () {
                            return !this$1.isToggled(this$1.$el) && this$1.toggleElement(this$1.$el, true);
                        },
                        tryShow = function () {
    ...
    function Hover(UIkit) {
        ...
        ready(function () {
            ...
            docElement.on('tap', function (ref) {
                ...
                return $$1__default(("." + cls)).filter(function (_, el) {
            ...
            return promise(
                function (resolve, reject) {
                    return UIkit.modal.dialog(("\n                <div class=\"uk-modal-body\">" + (isString(message) ? message : $$1__default(message).html()) + "</div>\n                <div class=\"uk-modal-footer uk-text-right\">\n                    <button class=\"uk-button uk-button-default uk-modal-close\">" + (options.labels.cancel) + "</button>\n                    <button class=\"uk-button uk-button-primary uk-modal-close\" autofocus>" + (options.labels.ok) + "</button>\n                </div>\n            "), options).$el.on('click', '.uk-modal-footer button', function (e) {
                        return $$1__default(e.target).index() === 0 ? reject() : resolve();
                    });
                }
            );
        };
        ...
        UIkit.component('navbar', {
            ...
            ready: function ready() {
                ...
                if (this.dropbar) {
                    ...
                    UIkit.navbarDropbar(this.dropbar, {
            ...
            update: [

                {
                    ...
                    read: function read() {
                        ...
                        this.targets = $$1__default($$1__default.map(this.links, function (el) {
                            return el.hash;
                        }).join(','));

                        if (this.scroll) {
                            this.links.each(function (_, el) {
                                return UIkit.scroll(el, {offset: this$1.offset || 0});
                            });
                        }
                    }
    ...
    function boot(UIkit) {
        ...
        if (Observer) {
            ...
            ready(function () {
                ...
                on(document.documentElement, 'DOMNodeInserted', function (e) {
                    return apply(e.target, UIkit.connect);
                });
                on(document.documentElement, 'DOMNodeRemoved', function (e) {
    ...
    function plugin(UIkit) {
        ...
        UIkit.component('lightbox', {
            ...
            ready: function ready() {
                ...
                this.toggles = $(this.toggle, this.$el).each(function (_, el) {
        ...
        UIkit.component('sortable', {
            ...
            methods: {
                ...
                init: function init(e) {
                    ...
                    var target = $(e.target), placeholder = this.$el.children().filter(function (i, el) {
