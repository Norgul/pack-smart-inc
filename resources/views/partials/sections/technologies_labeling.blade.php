                ...
                <div class="  uk-width-medium-2-3 uk-width-large-2-3">
                    ...
                    <div class="uk-grid" style="margin-bottom: 50px; ">
                        <p class="paragraph paragraph--muted">
                            Packing solutions from Pack-Smart comes in all designs,
                        </p>
                        <p class="paragraph paragraph--muted">
                            sizes and levels of complexity. It can be a single flow wrapping
                        </p>
                        <p class="paragraph paragraph--muted">
                            for protection or a customized design holding.
                        </p>
                    </div>
