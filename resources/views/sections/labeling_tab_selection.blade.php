	...
	<div class="uk-width-large-8-10">
			...
			<div class="uk-grid uk-grid-collapse" data-uk-grid-margin>
				<div class="uk-width-small-1-10 uk-width-medium-1-10 uk-width-large-1-10"></div>
					<div class="uk-width-small-8-10 uk-width-medium-8-10 uk-width-large-8-10 uk-container-center" style="padding-top: 50px; padding-bottom: 50px;">
						<div class="uk-slidenav-position" data-uk-slider="{activels: uk-slidenav}" style="height: inherit;">
							<div class="uk-slider-container" style="padding: 20px;">
								<ul class="uk-slider uk-grid uk-grid-width-medium-1-3  uk-grid-width-large-1-5">
									<li data-slider-slide="0" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="uk-slide-before hvr-grow">
										<img src="{{asset('images/labeling/pressure_sensitive.png')}}" draggable="false">
											<p>Pressure Sensitive</p>
									</li>
									<li data-slider-slide="1" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="uk-slide-before hvr-grow">
										<img src="{{asset('images/labeling/hot_melt.png')}}" draggable="false">
											<p>Hot melt</p>
									</li>
									<li data-slider-slide="2" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="hvr-grow">
										<img src="{{asset('images/labeling/wet_labels.png')}}" draggable="false">
											<p>Wet labels</p>
									</li>
									<li data-slider-slide="3" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="uk-slide-after hvr-grow">
										<img src="{{asset('images/labeling/magnetic_strip.png')}}" draggable="false">
											<p>Magnetic strip</p>
									</li>
									<li data-slider-slide="4" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="uk-slide-after hvr-grow">
										<img src="{{asset('images/labeling/3d_labels.png')}}" draggable="false">
											<p>3d labels</p>
									</li>
									<li data-slider-slide="5" style="text-align: center; text-transform: uppercase; margin-bottom: 10px;" class="uk-slide-before hvr-grow">
										<img src="{{asset('images/labeling/pressure_sensitive.png')}}" draggable="false">
											<p>Pressure Sensitive</p>
									</li>
								</ul>
	...
	<div class="section__inside" style="padding-bottom: 35px;">
		<div class="uk-grid">
			<div class="uk-width-1-1">
				...
				<p style="text-align:center; font-size: 17px; padding-top:20px;">
						Easily affix virtually any type and size of labels, they are designed to be highly flexible and versatile,
					</br>
						operating at amazing speeds with excellent accuracy.
					</br>
						Our labelers will easily integrate into your new or existing equipment, and allow for hassle-free setup,
					</br>
						24/7 non-stop operation and cost reduction.
				</p>
			</div>
		</div>
	    ...
	    <li class="uk-width-medium-1-3 uk-row-first">
	        <figure class="uk-overlay uk-overlay-hover">
	            ...
	            <figcaption class="uk-overlay-panel uk-overlay-background  uk-overlay-top uk-overlay-slide-top" style="background: rgba(211, 31, 38, 0.85); font-family: "HelveticaNeueW02-45Ligh";
						  font-size: 17px;">
	    ...
	    <li class="uk-width-medium-1-3">
			...
			<li class="uk-width-medium-1-3">
				<figure class="uk-overlay uk-overlay-hover">
						<img src="{{asset('images/labeling/contact-us-tile.jpg')}}" width="600" height="400" alt="Image">
