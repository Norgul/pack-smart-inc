	...
	<div class="uk-width-large-8-10">
			<div class="uk-grid" data-uk-grid-margin>
				...
				<div class="uk-width-large-6-10" >
					<h3 style="text-align: center; margin-top: 50px; ">Labeling Aplications</h3>
				</div>
				<div class="uk-width-large-2-10"></div>
			</div>
			<div class="uk-grid uk-grid-collapse" data-uk-grid-margin>
				<div class="uk-width-small-1-10 uk-width-medium-1-10 uk-width-large-1-10"></div>
					<div class="uk-width-small-8-10 uk-width-medium-8-10 uk-width-large-8-10 uk-container-center" style="padding-top: 25px; padding-bottom: 25px;">
		...
		<div class="uk-grid" data-uk-grid-margin>
			...
			<div class="button__group" style="padding-top: 20px; padding-bottom: 150px; float: right;">
                  <a href="{{ url()->previous() }}" class="uk-button uk-button-razor uk-button-primary ">
