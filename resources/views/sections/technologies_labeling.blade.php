                  ...
                  <h2 class="technologies-tab-h2">{{$title}}</h2>
                    ...
                    <div class="uk-grid" style="margin-bottom: 50px; ">
                        <p class="paragraph paragraph--muted">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a sapien quis lorem rutrum varius.
                            Cras ultricies sit amet sem nec efficitur. In dictum placerat malesuada. Sed tempor maximus auctor
                        </p>
                    </div>
